 ...
 * behavior.
 */
public class AdvancedProfiledPIDController implements Sendable {
    private static int instances;

    private PIDController m_controller;
    private double m_minimumInput;
    private double m_maximumInput;
    private AdvancedTrapezoidProfile.State m_goal = new AdvancedTrapezoidProfile.State();
    private AdvancedTrapezoidProfile.State m_setpoint = new AdvancedTrapezoidProfile.State();
    private AdvancedTrapezoidProfile.Constraints m_constraints;
     ...
     */
    public AdvancedProfiledPIDController(
            double Kp, double Ki, double Kd, AdvancedTrapezoidProfile.Constraints constraints) {
     ...
     */
    public AdvancedProfiledPIDController(
            double Kp, double Ki, double Kd, AdvancedTrapezoidProfile.Constraints constraints, double period) {
     ...
     */
    public void setGoal(AdvancedTrapezoidProfile.State goal) {
        m_goal = goal;
    }
    ...
    public void setGoal(double goal) {
        m_goal = new AdvancedTrapezoidProfile.State(goal, 0);
    }
     ...
     * @return The goal.
     */
    public AdvancedTrapezoidProfile.State getGoal() {
        return m_goal;
    }
     ...
     * @param constraints Velocity and acceleration constraints for goal.
     */
    public void setConstraints(AdvancedTrapezoidProfile.Constraints constraints) {
        m_constraints = constraints;
    }
     ...
     */
    public AdvancedTrapezoidProfile.State getSetpoint() {
        return m_setpoint;
    }
    ...
    public double calculate(double measurement) {
        ...
        var profile = new AdvancedTrapezoidProfile(m_constraints, m_goal, m_setpoint);
     ...
     * @return The controller's next output.
     */
    public double calculate(double measurement, AdvancedTrapezoidProfile.State goal) {
        setGoal(goal);
    ...
    public double calculate(
            double measurement, AdvancedTrapezoidProfile.State goal, AdvancedTrapezoidProfile.Constraints constraints) {
     ...
     */
    public void reset(AdvancedTrapezoidProfile.State measurement) {
        m_controller.reset();
    ...
    public void reset(double measuredPosition, double measuredVelocity) {
        reset(new AdvancedTrapezoidProfile.State(measuredPosition, measuredVelocity));
    }
