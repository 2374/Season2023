...
public class Wrist {
    ...
    // private final CANSparkMax motor = new CANSparkMax(Constants.Wrist.ID, CANSparkMax.MotorType.kBrushless); ELBOW_JOINT_LEFT_MOTOR_CAN_ID
    ...
    public Wrist(Arm arm) {
        ...
        m_elbowLeftJoint.configSupplyCurrentLimit(new SupplyCurrentLimitConfiguration(true, 40, 40, 0.2));
        m_elbowRightJoint.configSupplyCurrentLimit(new SupplyCurrentLimitConfiguration(true, 40, 40, 0.2));
    ...
    public void runWithVelocity(Rotation2d velocity) {
        ...
        runWithSetpoint(Rotation2d.fromRadians(m_elbowEncoder.getAbsolutePosition()), velocity);
    }
    ...
    public void runWithSetpoint(Rotation2d position, Rotation2d velocity) {
        ...
        m_elbowLeftJoint.setVoltage(feedforward.calculate(arm.getWristAngle().getRadians(), velocity.getRadians()));
    }
