...
// import frc.robot.subsystems.gArm.Wrist;
...
// private final Mechanism2d arm = new Mechanism2d(Units.inchesToMeters(28),
// Constants.Arm.PIVOT_HEIGHT + 0.5);
// private final MechanismRoot2d pivot = arm.getRoot("pivot",
// Units.inchesToMeters(22), Constants.Arm.PIVOT_HEIGHT);
...
// .append(new MechanismLigament2d("manipulator",
// Constants.Wrist.JOINT_TO_CORNER_DISTANCE, 0));

// private final MechanismLigament2d setHumerus = pivot
// .append(new MechanismLigament2d("set humerus", Constants.Arm.HUMERUS_LENGTH,
// 0));
// private final MechanismLigament2d setManipulator = setHumerus
// .append(new MechanismLigament2d("set manipulator",
// Constants.Wrist.JOINT_TO_CORNER_DISTANCE, 0));
...
// // Translation2d relativeWristOrigin =
// Constants.Arm.RELATIVE_WRIST_POSE.rotateBy(getShoulderAngle());
...
// .fromRadians(target.shoulderConeOffset.getRadians() +
// difference.getRadians());
// break;
// case Cube:
// target.shoulderCubeOffset = Rotation2d
// .fromRadians(target.shoulderCubeOffset.getRadians() +
// difference.getRadians());
// }
// }
...
// public enum State {
// Teller(Constants.Shoulder.TELLER_CONE_ANGLE,
// Constants.Shoulder.TELLER_CUBE_ANGLE,
// Constants.Wrist.TELLER_CONE_ANGLE, Constants.Wrist.TELLER_CUBE_ANGLE),
// Slide(Constants.Shoulder.SLIDE_CONE_ANGLE,
// Constants.Shoulder.SLIDE_CUBE_ANGLE,
...
// State(Rotation2d shoulderConeAngle, Rotation2d shoulderCubeAngle, Rotation2d
// wristConeAngle,
...
// return (gamePiece == GamePiece.Cone) ?
// this.wristConeAngle.plus(this.wristConeOffset)
