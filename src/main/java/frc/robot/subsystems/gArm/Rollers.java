...
// private final CANSparkMax motor = new CANSparkMax(Constants.Rollers.ID,
// CANSparkMaxLowLevel.MotorType.kBrushless);

// public Rollers() {
// motor.setIdleMode(CANSparkMax.IdleMode.kBrake);
// motor.restoreFactoryDefaults();
// //RobotContainer.armTab.addNumber("Roller Bus Voltage",
// motor::getBusVoltage).withWidget(BuiltInWidgets.kGraph);
// //RobotContainer.armTab.addNumber("Roller Applied Voltage",
// motor::getAppliedOutput).withWidget(BuiltInWidgets.kGraph);
// //RobotContainer.armTab.addNumber("Roller Compensation Voltage",
// motor::getVoltageCompensationNominalVoltage).withWidget(BuiltInWidgets.kGraph);
// }
