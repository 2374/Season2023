...
// private final CANSparkMax motor1 = new
// CANSparkMax(Constants.Shoulder.MOTOR_1_ID,
// CANSparkMaxLowLevel.MotorType.kBrushless);

// private final CANSparkMax motor2 = new
// CANSparkMax(Constants.Shoulder.MOTOR_2_ID,
// CANSparkMaxLowLevel.MotorType.kBrushless);
// private final AbsoluteEncoder encoder =
// motor1.getAbsoluteEncoder(SparkMaxAbsoluteEncoder.Type.kDutyCycle);
// protected ArmFeedforward feedforwardController = new
// ArmFeedforward(Constants.Shoulder.KS, Constants.Shoulder.KG,
// Constants.Shoulder.KV, Constants.Shoulder.KA);

// protected final PIDController pidController = new
// PIDController(Constants.Shoulder.KP, Constants.Shoulder.KI,
...
// motor1.getEncoder().setPositionConversionFactor(Units.rotationsToRadians(1) /
// 151.2);
...
// RobotContainer.armTab.add("Shoulder PID",
...
// /// Run the shoulder at the given setpoints using the feedforward and
// feedback controllers.
// /// @param position The position setpoint. Measured in radians from the
// vertical.
// /// @param velocity The velocity setpoint. Measured in radians per second.
// /// @param acceleration The acceleration setpoint. Measured in radians per
// second squared.
// public void runWithSetpoint(Rotation2d position, Rotation2d velocity,
// Rotation2d acceleration) {
