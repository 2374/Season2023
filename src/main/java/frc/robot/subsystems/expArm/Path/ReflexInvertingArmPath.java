package frc.robot.subsystems.expArm.Path;
...
import frc.robot.subsystems.expArm.ArmNamedPosition;
...
public class ReflexInvertingArmPath implements ArmPath {
    ...
    final double reflexDist = (Constants.ARM_FOREARM_LENGTH + Constants.ARM_BICEP_LENGTH);
    ...
    final double reflexEndPosY = reflexDist * Math.sin(reflexAngleRad) + Constants.ARM_SHOULDER_MOUNT_HEIGHT;
